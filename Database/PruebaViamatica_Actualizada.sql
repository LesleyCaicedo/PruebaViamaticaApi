USE [PruebaViamatica]
GO
/****** Object:  Table [dbo].[Opciones]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Persona]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Rol]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RolOpciones]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RolUsuarios]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sesiones]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuarios]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Persona] ([idPersona], [Nombre], [Apellido], [Cedula], [FechaNacimiento]) VALUES (6, N'Julio', N'Castro', N'0938193811', CAST(N'2024-01-22' AS Date))
...
INSERT [dbo].[RolUsuarios] ([FK_idRol], [FK_idUsuario]) VALUES (2, 6)
GO
INSERT [dbo].[Sesiones] ([FechaIngreso], [FechaCierre], [FK_idUsuario]) VALUES (CAST(N'2024-10-23T00:34:35.870' AS DateTime), CAST(N'2024-10-23T00:34:54.853' AS DateTime), 1)
GO
SET IDENTITY_INSERT [dbo].[Usuarios] ON 

INSERT [dbo].[Usuarios] ([idUsuario], [Usuario], [Clave], [Correo], [SesionActiva], [FK_idPersona], [Estatus], [IntentosTemp], [IntentosTotal]) VALUES (1, N'Andreacg03', N'B429E57667F6FF894841BE6BD32596CA51A016C28A4E3AAC5CC64EAC47129E43', N'acaicedo@mail.com', N'I', 1, N'Activo', 0, 7)
INSERT [dbo].[Usuarios] ([idUsuario], [Usuario], [Clave], [Correo], [SesionActiva], [FK_idPersona], [Estatus], [IntentosTemp], [IntentosTotal]) VALUES (5, N'Pepeprueba1', N'68134990EAB5CAD39191DFD020EAA02C1113FC98B7DDFB4C359864BD46BBF207', N'pcigarra@mail.com', N'I', 5, N'Activo', 0, 0)
INSERT [dbo].[Usuarios] ([idUsuario], [Usuario], [Clave], [Correo], [SesionActiva], [FK_idPersona], [Estatus], [IntentosTemp], [IntentosTotal]) VALUES (6, N'JulioCastro1', N'68134990EAB5CAD39191DFD020EAA02C1113FC98B7DDFB4C359864BD46BBF207', N'jcastro@mail.com', N'I', 6, N'Activo', 0, 0)
...
GO
/****** Object:  StoredProcedure [dbo].[ControlSesion]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[RolUsuario]    Script Date: 23/10/2024 0:42:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
